...
await conn.reply(m.chat, `${emoji2} Iniciando proceso de eliminación de todos los pecados de sesión, excepto el archivo creds.json...`, m)
m.react(rwait)
...
m.react(done)
await conn.reply(m.chat, `${emoji} Se eliminaron ${filesDeleted} pecados de sesión, excepto el archivo creds.json.`, m)
