...
export async function before(m, { conn, participants, groupMetadata }) {
  ...
  let pp = await conn.profilePictureUrl(m.messageStubParameters[0], 'image').catch(_ => 'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ9rIwlEnrxbyemvbtbokz7Rd5DC_1wqavseFCThNPmFwcCsGIQoHetKqtb&s=10.png')
